...
import com.unipi.cdsshop.crypto.Crypto;
...
public class UserDAO {
    ...
    public static User getUserById(int id) {
        try {
            ...
            String query = "SELECT * FROM cdsshopdb.user WHERE id = ?";
    ...
    public static int storeUserVerified(FormRegister formRegister) {
        try {
            ...
            String query = "INSERT INTO cdsshopdb.user (username, password, fullname, email, tel, status, code, salt) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
